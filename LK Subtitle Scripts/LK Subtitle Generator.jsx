    ...
    */
    ...
    function LK_SubtitleGenerator()
    {
        ...
        function presetStaticValues() {
            ...
            for (var i = s; i > 0; i--) { // 从倒数第一个向第一个素材遍历，目的是找到一个含有合成视频的素材（也就是我们当前工程中的“视频序列”）
         ...
         * @return {CompItem} app.project.item(index)
         */
                ...
                if (id > 0) {
                    for (var i = 0; i < id; i++) {
                        ...
                        if (app.project.item(INDEX).layers.byName('temp_layer_1') != null) {
                            app.project.item(INDEX).layers.byName('temp_layer_1').remove();
                            app.project.item(INDEX).layers.byName('temp_layer_2').remove();
                        }
                    }
                } else {
        ...
        function parsingSubtitleContents(layer_a, layer_b, layer_c, contents) {
            ...
            // Seperate str into 3 parts: text_a, text_b, text_c
            receipt = regexMe(str);
        ...
        function changeStatusIni(receipt) {
            ...
            */
            ...
            case 4:
                ...
                report[2] = "layer_b=false";
                report[3] = "layer_c=false";
                report[4] = "status=resume_d"; // derectly click btn4(dx, dy)
                break;
            case "error":
                // 发生未知错误，立刻退出
        ...
        function TimecodeFromAegToAE(i) {
            ...
            function AccurateTime(time) {
                ...
                if (timecode != "0:00:00.000") {
                    t = timecode.slice(0, 1) * 3600 + timecode.slice(2, 4) * 60 + timecode.slice(5, 7) * 1 + timecode.slice(-2) / 100; // = 0 hour // = 00 minute // = 06 seconds // = 810ms/1000 = 0.81s
                    // = 6.81s
