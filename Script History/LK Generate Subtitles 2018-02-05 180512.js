{
    ...
    function LK_GenerateSubtitles(thisObj)
    {
        ...
        // 设置按钮监听器
        btn_1.onClick = onBtn1Click('clicking'); // 创建本条字幕开始时间
        ...
        function onBtn5Click() {
            ...
            if (LANGUAGE == 'EN') {
                ...
                //file = new File(file.path + "/LK Import Subtitles 1.0.jsxbin");
                //file.open('r');
                //eval(file.read());
                //file.close();
                ...
                // Dev test:
                var file = new File($.fileName);
                file = new File(file.path + "/LK Import Subtitles.jsx");
                file.open('r');
                ...
                if (content != null) {
                    ...
                    alert('This file has no content.', 'Warning');
                }
            } else {
                alert('Target script-file (LK Import Subtitle Files 1.0.jsxbin) not found. \nPlease check whether had you renamed it.');
            } 
        }
        ...
        function onScriptButtonClick()
        {
            ...
            // The file variable was set during addButton.
