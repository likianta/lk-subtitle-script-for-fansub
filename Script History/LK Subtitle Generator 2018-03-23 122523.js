            ...
            */
            ...
            if (generate_mode = 'full_automatic') {
                ...
                if (generate_counter == 0) {
                     ...
                     * 5. 精灵进入等待状态
                     */
                    layer_c = createTempLayers(layer_c, 'type_c');
                    layer_b = createTempLayers(layer_b, 'type_b');
                ...
                function createTempLayers(layerName, format) {
                ...
                function launchGenius() {
                    ...
                    if (version_env == 'DEVELOP') {
                        ...
                        var script = getFilePath('/LK Subtitle Scripts/LK Anjian Genius.exe');
                    }
